"""
Django settings for FlushFM project.
...
SECRET_KEY = 'fc19qadc_-feimia%c#v%%p$w_okx-(^8oky)*uy&2#lq&i2tl'
...
ROOT_URLCONF = 'FlushFM.urls'

WSGI_APPLICATION = 'FlushFM.wsgi.application'
